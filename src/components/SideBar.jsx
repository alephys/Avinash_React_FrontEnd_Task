...
//       fetchTopics(); // Call the async function here
//     }, [role]);

//     useEffect(() => {
//       const refreshSidebar = () => {
//         fetchTopics(); // refresh sidebar topics automatically
//       };
...
//                   key={topic.id}
//                   onClick={() =>
//                     navigate(`/topic/${encodeURIComponent(topic.name)}`) // click on topic to show topic details
//                   }
...
function SideBar() {
  ...
  // auto-refresh every 10s in case user stays idle
  useEffect(() => {
